...
const hasUpperCase = (str) => str.split('').some(el => el >= 'A' &&  el <= "Z" ? true : false) 
...
// Task - 4
/*Requirement:
Write a function name no13() which takes an array of numbers as argument 
...
console.log(categorizeCharacters('ab45@&@jfsl1234*&^&980ndRFH'))